...
public class CreateAccountPage {
    ...
    public static final Target MALE_RADIO_BUTTON = Target.the("Mr. gender radio button")
            .located(By.id("id_gender1"));

    public static final Target FEMALE_RADIO_BUTTON = Target.the("Mrs. gender radio button")
            .located(By.id("id_gender2"));

    public static final Target ACCOUNT_FORM = Target.the("registration form")
    ...
    public static final Target DAY_DROPDOWN = Target.the("Day of birth dropdown")
            .located(By.id("days"));
    public static final Target MONTH_DROPDOWN = Target.the("Month of birth dropdown")
            .located(By.id("months"));

    public static final Target YEAR_DROPDOWN = Target.the("Year of birth dropdown")
            .located(By.id("years"));

    public static final Target EMAIL_CREATE_FIELD = Target.the("email address field for account creation")
