...
public class CartPage {
    ...
    public static final Target SUCCESS_MESSAGE = Target.the("Sign in link").located(By.xpath("(//h2[normalize-space()='Product successfully added to your shopping cart'])[1]"));
